...
projectMake: projectMake.o configLoader.o int.o memory.o avlBinTree.o stack.o list.o string.o fileIO.o argparse.o array.o alist.o filePath.o sorting.o console.o directory.o
	gcc -Wall -o build/projectMake objects/projectMake.o objects/configLoader.o objects/int.o objects/memory.o objects/avlBinTree.o objects/stack.o objects/list.o objects/string.o objects/fileIO.o objects/argparse.o objects/array.o objects/alist.o objects/filePath.o objects/sorting.o objects/console.o objects/directory.o -g
...
list_files_in_dir: list_files_in_dir.o configLoader.o int.o memory.o avlBinTree.o stack.o list.o string.o fileIO.o argparse.o array.o alist.o filePath.o sorting.o console.o directory.o
	gcc -Wall -o build/list_files_in_dir objects/list_files_in_dir.o objects/configLoader.o objects/int.o objects/memory.o objects/avlBinTree.o objects/stack.o objects/list.o objects/string.o objects/fileIO.o objects/argparse.o objects/array.o objects/alist.o objects/filePath.o objects/sorting.o objects/console.o objects/directory.o -g
...
projectScan: projectScan.o configLoader.o int.o memory.o avlBinTree.o stack.o list.o string.o fileIO.o argparse.o array.o alist.o filePath.o sorting.o console.o directory.o
	gcc -Wall -o build/projectScan objects/projectScan.o objects/configLoader.o objects/int.o objects/memory.o objects/avlBinTree.o objects/stack.o objects/list.o objects/string.o objects/fileIO.o objects/argparse.o objects/array.o objects/alist.o objects/filePath.o objects/sorting.o objects/console.o objects/directory.o -g
...
testing.o: src/main/testing.c
	gcc -Wall -c -o objects/testing.o src/main/testing.c -g
