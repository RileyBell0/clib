...
// void write_make_all_components(FILE* outFile, alist_t* component_names);
// void write_make_all_call(FILE* outFile, alist_t* prog_names);
...
//     */
//     alist_t prog_files = fileio_read_all_lines_alist(prog_files_loc._str);
//     alist_t obj_files = fileio_read_all_lines_alist(component_files_loc._str);

//     /*
//      * Parsing read data
//     */
//     alist_t prog_names = get_file_names_from_paths(prog_files);
//     alist_t obj_names = get_file_names_from_paths(obj_files);
//     remove_file_extensions(prog_names);
//     remove_file_extensions(obj_names);

//     alist_t prog_out_names = new_list(sizeof(string_t));
//     list_node_t* node = prog_names.first_node;
//     while (node)
//     {
...
//         node = node->next;
//     }
//     alist_t prog_obj_out = new_list(sizeof(string_t));
...
//         node = node->next;
//     }
//     alist_t obj_out_names = new_list(sizeof(string_t));
